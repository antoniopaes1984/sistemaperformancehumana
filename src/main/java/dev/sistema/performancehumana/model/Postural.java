...
@Entity
@Table(name="postural")
@SequenceGenerator(name="seq_postural", sequenceName = "seq_postural", allocationSize = 1, initialValue = 1)
public class Postural implements Serializable {

	
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="seq_postural")
	private long codPostural;
	...
	public long getCodPostural() {
		return codPostural;
	}
	public void setCodPostural(long codPostural) {
