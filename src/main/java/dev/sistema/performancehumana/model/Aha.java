...
@Entity
@Table(name="aha")
@SequenceGenerator(name="seq_aha", sequenceName = "seq_aha",allocationSize = 1, initialValue = 1)
public class Aha implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_aha")
	private long codAha;
	...
	public long getCodAha() {
		return codAha;
	}

	public void setCodAha(long codAha) {
		this.codAha = codAha;
	}
