...
@Entity
@Table(name="medidas")
@SequenceGenerator(name="seq_medidas", sequenceName = "seq_medidas", allocationSize = 1, initialValue = 1)
public class Medidas implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_medidas")
